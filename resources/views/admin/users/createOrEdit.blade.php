                                ...
                                <select id="preferred_countries" name="preferences[countries][]"
                                    ...
                                    @foreach ($countries as $country)
                                        <option value="{{ $country->id }}"
                                            @if (isset($user->preference) && is_array($user->preference->countries) && in_array($country->id, $user->preference->countries)) selected @endif
                                            @if (old('preferences.countries') && in_array($country->id, old('preferences.countries'))) selected @endif>{{ $country->name }}</option>
                                    @endforeach
                                </select>
                            </div>
