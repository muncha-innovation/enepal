...
@section('content')
    <h1 class="text-2xl font-semibold text-gray-700 mb-2">Business Facilities</h1>
                        ...
                        <thead class="bg-gray-50">
                            <tr>
                                <th scope="col"
                                    ...
                                    <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">{{__('Business Types')}}
                                    </th>
                                ...
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">
                                        @foreach ($facility->businessTypes as $businessType)
                                            <span class="inline-block px-2 py-1 text-xs font-semibold text-white bg-indigo-500 rounded-full">
                                                {{$businessType->title}}
                                            </span>
                                        @endforeach
                                    </td>
