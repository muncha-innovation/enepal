                ...
                <div class="mb-2">
                    <div class="mb-2">
                        ...
                        <div class="mt-2 rounded-md shadow-sm">
                            <input type="text" name="name" id="name" placeholder="Eg.Parking"
                                value="{{ $facility->name }}"
                    ...
                    <div class="mb-2">
                        <label for="input_type" class="block text-sm font-medium leading-6 text-gray-900">Input Type</label>
                        <div class="mt-2 rounded-md shadow-sm">
                            <select name="input_type" id="input_type"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                <option value="radio" {{ $facility->input_type == 'radio' ? 'selected' : '' }}>Yes/No</option>
                                <option value="text" {{ $facility->input_type == 'text' ? 'selected' : '' }}>Text</option>
                                <option value="number" {{ $facility->input_type == 'number' ? 'selected' : '' }}>Number</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-2">
                        <label for="business_types" class="block text-sm font-medium leading-6 text-gray-900">Business Types</label>
                        <div class="mt-2 rounded-md shadow-sm">
