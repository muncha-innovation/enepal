<aside class="sticky top-0 flex flex-col items-center w-16 min-h-screen h-full py-8 overflow-y-auto bg-white border-r">
  <nav class="flex flex-col flex-1 space-y-6">
    ...
    <a href="#" title="Home" class="p-1.5 text-gray-700 focus:outline-nones transition-colors duration-200 rounded-lg hover:bg-gray-100">
