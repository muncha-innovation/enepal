        ...
        <div x-data="{ open: {{ $isBusinessRoute }} }" class="space-y-1">
            ...
            <div x-show="open" class="space-y-1">
                <a href="{{ route('business.index') }}"
                    class="flex items-center w-full py-2 pl-10 pr-2 text-sm font-medium text-gray-500 rounded-md group hover:bg-gray-100 hover:text-gray-900 @if (url()->current() == route('business.index')) bg-gray-200 @endif">List</a>
