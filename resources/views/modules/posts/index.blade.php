          ...
          <tbody class="divide-y divide-gray-200 bg-white">
            ...
            <tr>
              ...
              <td class="px-3 py-3.5 text-sm font-medium text-gray-900">
                ...
                {{-- <a href="{{ route('posts.destroy', [$business, $post]) }}" class="bg-red-500 text-white relative inline-flex items-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-semibold ring-1 ring-inset ring-red-500 hover:bg-red-600 focus:z-10">Delete</a> --}}
              </td>
            @endforeach
          </tbody>
        </table>
