<a href="{{ route('business.communications.index', ['business' => $business]) }}" 
        ...
        <li class="mr-2">
            <a href="{{ route('business.owner-profile', ['business' => $business]) }}"
               class="inline-flex items-center p-4 border-b-2 rounded-t-lg {{ request()->routeIs('business.owner-profile') ? 'text-blue-600 border-blue-600 active' : 'border-transparent hover:text-gray-600 hover:border-gray-300' }}">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
