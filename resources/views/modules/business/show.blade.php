...
<section>
  <div class="bg-gray-300 h-56 w-full relative">
    <img src="{{getImage($business->logo,'business/logo/')}}" alt="cover" class="absolute -bottom-12 left-10 rounded-xl w-48 h-48 object-cover">
  </div>
  <div class="flex justify-end py-4">
    <span class="isolate inline-flex rounded-md shadow-sm">
      <a href="{{ route('business.member.add', $business) }}">
