...
@section('content')
    ...
    @endif
    <h1 class="text-2xl font-semibold text-gray-700 mb-2">{{ __('Profile') }}</h1>
    ...
    <section>
        <div class="bg-white p-4 shadow rounded">
            ...
            <form id="profileForm" route="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                ...
                <div class="mb-2">
                    <label for="first_name"
                        class="block text-sm font-medium leading-6 text-gray-900">{{ __('First Name') }} <span class="text-red-500">*</span></label>
                ...
                <div class="mb-2">
                    <label for="last_name"
                        class="block text-sm font-medium leading-6 text-gray-900">{{ __('Last Name') }} <span class="text-red-500">*</span></label>
                    <div class="mt-2 rounded-md shadow-sm">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="mt-1">
                            <select id="country" name="address[country_id]"
                    ...
                    <div>
                        <label for="address[state_id]" class="block text-sm font-medium text-gray-700">
                            {{ __('State') }} <span class="text-red-500">*</span></label>
                        <div class="mt-1">
                ...
                <div class="mb-2">
                    <label for="address[city]" class="block text-sm font-medium leading-6 text-gray-900">City <span class="text-red-500">*</span></label>
                    <div class="mt-2 rounded-md shadow-sm">
