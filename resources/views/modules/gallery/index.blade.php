...
@section('content')
@include('modules.business.header', ['title' => 'Gallery'])

<div class="sm:flex sm:items-center">
  <div class="sm:flex-auto">
    <h1 class="text-base font-semibold leading-6 text-gray-900">Galleries</h1>
    </div>

  <div class="flex gap-2">
    <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
      <a href="{{ route('gallery.create', $business) }}" class="block rounded-md bg-indigo-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Add Gallery</a>
        ...
        <table class="min-w-full divide-y divide-gray-300">
          <thead class="bg-gray-50">
            <tr>
              ...
              <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Cover Image</th>
              <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Images Count</th>
          ...
          <tbody class="divide-y divide-gray-200 bg-white">
            ...
            <tr>
              ...
              <td class="px-3 py-3.5 text-sm font-medium text-gray-900">
                ...
                <a href="{{ route('gallery.destroy', [$business, $gallery]) }}" class="delete bg-red-500 text-white relative inline-flex items-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-semibold ring-1 ring-inset ring-red-500 hover:bg-red-600 focus:z-10">Delete</a>
              </td>
            @endforeach
          </tbody>
        </table>
